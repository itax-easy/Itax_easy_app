...
class NoteTypeDropdown extends StatefulWidget {
  ...
  @override
  State<NoteTypeDropdown> createState() => _NoteTypeDropdownState();
}

class _NoteTypeDropdownState extends State<NoteTypeDropdown> {
